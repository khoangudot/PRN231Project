    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Eiichiro Oda", "Greatness, Glory, Gold. A Pirate Named Gold Roger also known as the Pirate King has conquered this all. He was executed with an unknown reason but before he died he had revealed his last word about The legendary Treasure named One Piece which was hidden in the Grand Line. 22 years after his Death, A Pirate named Monkey D. Luffy appeared and has only one Goal, To Become the Next \"Pirate King\" and Find The Treasure \"One Piece\".", new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6554), "", true, "One Piece", 0 },
                    { 2, "Murata Yuusuke", "imitates the life of an average hero who wins all of his fights with only one punch! This is why he is called Onepunch man Manga. This story takes place in the fictional Z-City. The world is full of mysterious beings, villains and monsters that cause destruction and havoc. An association of heroes has been established to protect the citizens from all harms and enemies. People with superhuman ability can register themselves with the association that protects citizens.", new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6564), "", true, "One Punch Man", 0 },
                    { 3, "Dian Hui Kuang", "Once it starts up, the dungeon goes through a process called “Reset the Next User”. Why doesn’t this reset process apply to me ?!I am the only one left from that endless reset of this dungeon. With simple skills and an overwhelming weapon, Jung-down game starts inside the dungeon", new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6567), "", true, "I Returned as an FFF-Class Witch", 0 },
                    { 4, "Jang Sung-Lak", "", new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6569), "", true, "Solo Leveling", 0 },
                    { 5, "Fujimono Tatsuki", "There's a new hero in town and he's got a bad attitude and a chainsaw dog demon! A dangerous combo.", new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6571), "", true, "Chainsaw Man", 0 },
                    { 6, "Endou Tatsuya", "The master spy codenamed has spent his days on undercover missions, all for the dream of a better world. But one day, he receives a particularly difficult new order from command. For his mission, he must form a temporary family and start a new life?! A Spy/Action/Comedy about a one-of-a-kind family!", new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6572), "", true, "Spy x Family", 0 },
                    { 7, "Hara Yasushia", "Millions of years have passed since the times of legends, when the worlds of man and gods were still the same. In these times it was the desires of man that moved the world. It is the era of the 500 year war: The warring states period. Kingdom is the story of a young boy named Shin who grew into a great general and all the trials and bloodshed that lead him there.", new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6574), "", true, "Kingdom", 0 },
                    { 8, "Kisimoto Masashi", "Ichigo Kurosaki has always been able to see ghosts, but this ability doesn't change his life nearly as much as his close encounter with Rukia Kuchiki, a soul reaper and member of the mysterious Soul Society. While fighting a hollow, an evil spirit that preys on humans who display spiritual energy, Rukia attempts to lend Ichigo some of her powers so that he can save his family; but much to her surprise, Ichigo absorbs every last drop of her energy.", new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6575), "", true, "Bleach", 0 },
                    { 9, "Toriyama Akira", "Son Goku's adventure starts with Bulma crashing into to him while she is searching for the seven magical Dragon Balls, which can grant any wish. Together, they meet many people and many foes in their adventure chasing after the Dragon Balls.", new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6576), "", true, "Dragon Ball Super", 0 },
                    { 10, "Hieaki Sorachi", "The samurai didn't stand a chance. First, the aliens invaded Japan. Next, they took all the jobs. And then they confiscated everyone's swords. So what does a hotheaded former samurai like Sakata \"Gin\" Gintoki do to make ends meet? Take any odd job that comes his way, even if it means losing his dignity.", new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6580), "", true, "Gintama", 0 },
                    { 11, "Slave In Utero", "What do you desire? Fortune? Glory? Power? Revenge? Or something that surpasses all others? What ever you desire, 'that is here'. Tower of God.", new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6582), "", true, "Tower Of God", 0 },
                    { 12, "Sang Ah", "What would happen if your world suddenly turned into a game?If you could level up and raise your stats?An adventure of a life-turned-game", new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6583), "", true, "The Gamer", 0 },
                    { 13, "Siyun", "Noh Eunha. After losing his family and closing off his heart, he just wanted to kill the monsters he loathed. I regressed before my life came to an end in the deepest part of the that was impossible for mankind to raid.", new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6584), "", true, "Relife Player", 0 },
                    { 14, "Park tae jun", "Federal Informant Baek Yisu and a criminal gangs boss, Baek Dogyeong are twin brothers. With the same faces the two twin brothers have lived different lives until now. Yisu, whos been betrayed by the gang, throws away his identity to become his brother. This federal agent is soon to become the gangs boss!", new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6586), "", true, "Baek XX", 0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6725), 1, 1, 0 },
                    { 2, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6727), 2, 1, 0 },
                    { 3, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6728), 3, 1, 0 },
                    { 4, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6729), 4, 1, 0 },
                    { 5, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6730), 5, 1, 0 },
                    { 6, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6731), 6, 1, 0 },
                    { 7, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6732), 7, 1, 0 },
                    { 8, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6733), 8, 1, 0 },
                    { 9, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6735), 9, 1, 0 },
                    { 10, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6736), 10, 1, 0 },
                    { 11, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6737), 1, 2, 0 },
                    { 12, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6738), 2, 2, 0 },
                    { 13, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6739), 3, 2, 0 },
                    { 14, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6740), 4, 2, 0 },
                    { 15, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6741), 5, 2, 0 },
                    { 16, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6743), 1, 3, 0 },
                    { 17, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6744), 2, 3, 0 },
                    { 18, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6745), 3, 3, 0 },
                    { 19, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6746), 4, 3, 0 },
                    { 20, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6747), 5, 3, 0 },
                    { 21, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6748), 1, 4, 0 },
                    { 22, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6749), 2, 4, 0 },
                    { 23, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6750), 3, 4, 0 },
                    { 24, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6751), 4, 4, 0 },
                    { 25, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6752), 5, 4, 0 },
                    { 26, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6753), 1, 5, 0 },
                    { 27, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6754), 2, 5, 0 },
                    { 28, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6755), 3, 5, 0 },
                    { 29, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6756), 4, 5, 0 },
                    { 30, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6757), 5, 5, 0 },
                    { 31, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6758), 1, 6, 0 },
                    { 32, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6759), 2, 6, 0 },
                    { 33, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6760), 3, 6, 0 },
                    { 34, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6761), 4, 6, 0 },
                    { 35, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6762), 5, 6, 0 },
                    { 36, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6763), 1, 7, 0 },
                    { 37, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6764), 2, 7, 0 },
                    { 38, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6765), 3, 7, 0 },
                    { 39, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6766), 4, 7, 0 },
                    { 40, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6767), 5, 7, 0 },
                    { 41, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6768), 1, 8, 0 },
                    { 42, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6769), 2, 8, 0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 43, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6770), 3, 8, 0 },
                    { 44, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6771), 4, 8, 0 },
                    { 45, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6772), 5, 8, 0 },
                    { 46, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6773), 1, 9, 0 },
                    { 47, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6774), 2, 9, 0 },
                    { 48, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6775), 3, 9, 0 },
                    { 49, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6776), 4, 9, 0 },
                    { 50, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6777), 5, 9, 0 },
                    { 51, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6778), 1, 10, 0 },
                    { 52, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6779), 2, 10, 0 },
                    { 53, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6780), 3, 10, 0 },
                    { 54, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6781), 4, 10, 0 },
                    { 55, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6782), 5, 10, 0 },
                    { 56, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6783), 1, 11, 0 },
                    { 57, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6784), 2, 11, 0 },
                    { 58, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6785), 3, 11, 0 },
                    { 59, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6786), 4, 11, 0 },
                    { 60, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6787), 5, 11, 0 },
                    { 61, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6788), 1, 12, 0 },
                    { 62, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6790), 2, 12, 0 },
                    { 63, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6791), 3, 12, 0 },
                    { 64, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6792), 4, 12, 0 },
                    { 65, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6793), 5, 12, 0 },
                    { 66, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6794), 1, 13, 0 },
                    { 67, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6795), 2, 13, 0 },
                    { 68, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6796), 3, 13, 0 },
                    { 69, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6797), 4, 13, 0 },
                    { 70, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6798), 5, 13, 0 },
                    { 71, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6799), 1, 14, 0 },
                    { 72, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6800), 2, 14, 0 },
                    { 73, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6801), 3, 14, 0 },
                    { 74, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6802), 4, 14, 0 },
                    { 75, new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6803), 5, 14, 0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Good Story", new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6623), 1, null, 1, 2 },
                    { 7, "This story is crazyyy", new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6631), 2, null, 1, 3 }
                });
            ...
            migrationBuilder.InsertData(
                table: "Comments",
                columns: new[] { "CommentId", "Content", "CreatedAt", "Index", "ParentCommentId", "StoryId", "UserId" },
                values: new object[] { 2, "I don't think so", new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6625), 1, 1, 1, 3 });

            migrationBuilder.InsertData(
                table: "Comments",
                columns: new[] { "CommentId", "Content", "CreatedAt", "Index", "ParentCommentId", "StoryId", "UserId" },
                values: new object[] { 3, "It's not good at all", new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6626), 2, 1, 1, 4 });

            migrationBuilder.InsertData(
                table: "Comments",
                columns: new[] { "CommentId", "Content", "CreatedAt", "Index", "ParentCommentId", "StoryId", "UserId" },
                values: new object[] { 4, "LOL", new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6627), 3, 1, 1, 5 });

            migrationBuilder.InsertData(
                table: "Comments",
                columns: new[] { "CommentId", "Content", "CreatedAt", "Index", "ParentCommentId", "StoryId", "UserId" },
                values: new object[] { 5, "Why", new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6628), 1, 2, 1, 2 });

            migrationBuilder.InsertData(
                table: "Comments",
                columns: new[] { "CommentId", "Content", "CreatedAt", "Index", "ParentCommentId", "StoryId", "UserId" },
                values: new object[] { 6, "Because Main is OP", new DateTime(2024, 2, 22, 14, 7, 43, 537, DateTimeKind.Local).AddTicks(6630), 1, 5, 1, 3 });
